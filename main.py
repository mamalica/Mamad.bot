...
async def start_link(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    args = context.args
    if not args:
        await update.message.reply_text("سلام! برای دریافت ویدیو از لینک های اختصاصی در کانال سکسولوژی استفاده کنید.")
        return
    ...
    if not await is_member(user.id, context):
        ...
        await update.message.reply_text(
            "❌ اول عضو کانال شو عزیزم بعد مجددا روی لینک ویدیو بزن😘.",
